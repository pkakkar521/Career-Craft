...
import './Homepage.css';
import ChatDashboard from "../components/Notespage/NoteCard/NoteCard";
...
const Homepage=({userName})=>{
 ...
 const [firstname,setfirstname]=useState("");
    ...
    const result = await fetch (BASE_URL+'note/reg',{
      method:'post',
    ...
    {/* <h1 className="hh">Products</h1>
      ...
      
        {
		 ...
		 <button className="toggle-chat-button" onClick={toggleChat}>
            ...
            <ChatDashboard userName={userName} isChatOpen={isChatOpen} />
