      ...
      <div class="diffSection" id="team_section">
        ...
        <div class="totalcard">
          <div class="card">
            ...
            <center>
              <div class="card-title">Ripunjay Sharma</div>
              <div id="detail">
                <p>
          ...
          <div class="card">
            ...
            <center>
              <div class="card-title">Pratham Kakkar</div>
              <div id="detail">
                <p>
          ...
          <div class="card">
            ...
            <center>
              <div class="card-title">Tushar Sharma</div>
              <div id="detail">
                <p>
                  “ Real education should consist of drawing the goodness and
                  the best out of our own students. What better books can there
          ...
          <div class="card">
            ...
            <center>
              <div class="card-title">Ayush Ranjan</div>
              <div id="detail">
                <p>
                  “ Real education should consist of drawing the goodness and
                  the best out of our own students. What better books can there
      ...
      <footer>
        <div class="footer-container">
          <div class="left-col">
            ...
            <br></br>
            <p>
              <img src={phone} /> +91-1234-444-6666<br></br>
              <img src={mail} />
