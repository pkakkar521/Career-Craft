...
import organic from "../image/organic.jpg";
import dropdown from "../image/dropdown.png";
import inorganic from "../image/inorganic.jpg";
import physical from "../image/physical.jpg";
import physics from "../image/physics.jpg";
import math from "../image/math.jpg";
import paper from "../image/paper-download.png";
import './Jeemain.css';
...
return (
    ...
    <div class="tt">
    <span>Prepare for JEE Mains & Advanced<br/>on Career Craft</span>
    <div class="shortdesc">
...
<div class="course">
	...
	<center>
		<div class="ccardbox">
			<div class="dcard">
				<div class="fpart"><img src={organic}/></div>
				<a href="#organic"><div class="spart">2 Courses <img src={dropdown}/></div></a>
			</div>
			<div class="dcard">
				<div class="fpart"><img src={inorganic}/></div>
				<a href="#inorganic"><div class="spart">5 Courses <img src={dropdown}/></div></a>
			</div>
			<div class="dcard">
				<div class="fpart"><img src={physical}/></div>
				<a href="#physical"><div class="spart">3 Courses <img src={dropdown}/></div></a>
			</div>
		</div>
		<div class="ccardbox">
			<div class="dcard">
				<div class="fpart"><img src={physics}/></div>
				<a href="#physics"><div class="spart">6 Courses <img src={dropdown}/></div></a>
			</div>
			<div class="dcard">
			...
			<div class="dcard">
				<div class="fpart"><img src={paper}/></div>
				<a href="#sample_papers"><div class="spart">1 Courses <img src={dropdown}/></div></a>
			</div>
		</div>
	</center>
	</div>
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src={organic}/>
...
<br></br>
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src={inorganic}/>
...
<br></br>
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src={physical}/>
...
<br></br>
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src={physics}/>
